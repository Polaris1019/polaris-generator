...
public class MetaValidator {
    ...
    private static void validAndFillConfig(Meta meta) {
        ...
        // outputRootPath：默认为当前路径下的 generated路径
    ...
    private static void validAndFillMetaRoot(Meta meta) {
        ...
        String basePackage = StrUtil.blankToDefault(meta.getBasePackage(), "com.polaris");
        String version = StrUtil.emptyToDefault(meta.getVersion(), "1.0");
        String author = StrUtil.emptyToDefault(meta.getAuthor(), "Polaris");
